...
@section('heading','Add University')
@section('content')
    <div class="card">
        <div class="card-body">
                ...
                <div class="row">
                    <div class="col-12 col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('university_code') border-danger @enderror" id="university_code" name="university_code" value="{{ old('university_code') }}">
                    ...
                    <div class="col-12 col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('university_name') border-danger @enderror" id="university_name" name="university_name" value="{{ old('university_name') }}">
